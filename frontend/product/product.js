// Product specific code (uses utils.js for common functions)
...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  // Load product details after menu is loaded (pass the ID from URL)
...
function loadProductDetails(foodId) {
  ...
  // Parse ingredients using utils.js function
